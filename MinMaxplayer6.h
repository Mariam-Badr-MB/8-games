...
template <typename T>
class X_O_MinMax_Player6 : public Player<T> {
public:
    X_O_MinMax_Player6(string name, T symbol);
...
template <typename T>
X_O_MinMax_Player6<T>::X_O_MinMax_Player6(string name, T symbol) : Player<T>(symbol) {
    this->name = name;
}

template <typename T>
void X_O_MinMax_Player6<T>::getmove(int& x, int& y) {
...
template <typename T>
int X_O_MinMax_Player6<T>::calculateMinMax(T s, bool isMaximizing) {
...
template <typename T>
std::pair<int, int> X_O_MinMax_Player6<T>::getBestMove() {
